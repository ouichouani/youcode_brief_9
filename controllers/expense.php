...
class Expense
{
    ...
    function create()
    {
        try {
            ...
            //PREPARE STATEMENT TO CREATE NEW EXPENSE
            $stat = $connection->prepare('INSERT INTO expenses (amount, description , category_id ) VALUES (? , ?  , ?)');
    ...
    {
        $connection = Connection::connect_PDO();
        $statement = $connection->prepare("SELECT e.* FROM expenses e
    ...
    public static function getById($id)
    {
        ...
        try {
            ...
            $statement = $connection->prepare("SELECT * FROM expenses WHERE id = ?");
    ...
    public static function getByCategory($category_id) {
        ...
        try {
            ...
            $statement = $connection->prepare("SELECT * FROM expenses WHERE category_id = ?");
    ...
    public static function get_total_expenses(){
        ...
        $connection = Connection::connect_PDO() ;
        $statement = $connection->prepare('SELECT sum(e.amount) as total_expenses FROM expenses e
        INNER JOIN categories c ON c.id = e.category_id
        WHERE c.user_id = ?');
        $statement->execute([$_SESSION['AuthUser']['id']]) ;
